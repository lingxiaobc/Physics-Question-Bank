...
description: 从 PDF 文件或者图片文件中提取物理题目，按照标准化格式输出为 Markdown。自动提取题目配图和解析配图保存到 image 文件夹，使用 LaTeX 格式化公式。适用于物理题库整理、题目录入、PDF 题目数字化等场景。
---
...
常用知识点标签参考：
- 运动的描述:#位移与路程,#时间与时刻,#加速度、速度基本概念,#v-t的理解与运用
...
1. **公式转换**：确保所有数学公式都转换为 LaTeX 格式，所有公式务必全部用$$...$$的格式进行编写
