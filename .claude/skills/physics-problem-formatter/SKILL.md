...
```markdown
![图片描述](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-5.1-014-question.png)
```
...
![玉兔二号月球车照片](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-5.1-014-question.png)
**选项**：
A. 受到月球的引力为1 350N
B. 在AB段运动时一定有加速度
C. OA段与AB段的平均速度方向相同
