...
**答案**：C
**解析**：如果是在傍晚，飞机正在由东向西飞行，飞机的速度大于当地纬度较高地区地球自转的线速度，则地球表面的人看到太阳从西方落下来，飞机上的旅客可以看到太阳从西边升起，如图所示![图中有一个太阳和一个地球，同时还标明了西北方向以及地球的自转方向。](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-001-analyze.png)
...
![七架简笔画的飞机带着对应的拖尾](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-002-question.png)
**选项**：
 A. 以某飞机为参考系，其他飞机是静止的
...
![直升飞机排成数字70的样式](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-003-question.png)
**选项**：
A. 以甲为参考系，乙是运动的
B. 以乙为参考系，甲是运动的
...
![奋斗者号的黑白照片](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-004-question.png)
**选项**：
A. 估算下降总时间时
B. 用推进器使其转弯时
C. 在海沟中穿越窄缝时
...
![总共有4张图，2乘2排列。左上是一只正在跳跃的猫，右上是一只沾水并在旋转的网球，左下是一只正在啄食的鸟，右下是一只奔腾的马。](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-005-question.png)
**选项**：
...
**难度**：0.9
**题型**：单选题
**题目描述**：![总共有4张图，2乘2排列,从左到右、从上往下分别标记为甲、乙、丙、丁。左上的女生正在打排球，右上的男生正在打乒乓球，左下的男生正在打羽毛球，右下的女生正在做体操运动。](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-006-question.png)
**选项**：
...
![图中共有4张图片，2乘2排列。左上展示的是跳水运动，右上展示的是体操运动，左下展示的是百米比赛，右下展示的是攀岩运动。](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-007-question.png)
**选项**：
A. 研究甲图运动员的入水动作
B. 研究乙图运动员的空中转体姿态
...
**题型**：单选题
**题目描述**：
“神舟十五号”飞船和空间站“天和”核心舱成功对接后，在轨运行如图所示，则![神舟15号飞船和空间站成功对接后的黑白照片。](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-008-question.png)
**选项**：
A. 选地球为参考系，“天和”是静止的
...
![水上滑道照片](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-013-question.png)
**选项**：
A. 位移一定相同
B. 时间一定相同
C. 末速度一定相同
...
![玉兔二号月球车照片](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-014-question.png)
**选项**：
A. 受到月球的引力为1 350N
B. 在AB段运动时一定有加速度
C. OA段与AB段的平均速度方向相同
...
![九曲溪漂流示意图，标注了双乳峰、玉女峰、大王峰、M点和N点的位置](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-015-question.png)
**选项**：
A. 游客的位移大小为5.4km
B. 游客的平均速率为5.4m/s
C. 游客的平均速度大小为0.5m/s
...
![祝融号火星车行驶路线图，标注了O点为着陆点、M点和N点的位置](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-016-question.png)
**选项**：
A. 从O处行驶到N处的路程为697米
...
![塔式起重机俯视图，显示轨道、桥架和小车的位置关系](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-017-question.png)
**选项**：
A. 6m
B. 8m
C. 10m
D. 14m
**答案**：C
**解析**：![](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P2026-01-1.1-017-analysis.png)如图所示，以地面为参考系，则在该次作业中小车相对地面的位移大小为 $$\sqrt{6^2 + 8^2} \, \text{m} = 10 \, \text{m}$$，故C正确。
...
![高铁车厢内显示屏照片](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-018-question.png)
**选项**：
A. 600m
B. 1200m
C. 2160m
...
![解析图解](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-022-analysis.png)
...
![超声波测速与测量车速的示意图以及信号图](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-023-question.png)
**答案**：17；17.9
...
![P-2026-01-1.1-023解析示意图](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-023-analysis.png)
(2)求解：第1步，先读出图B中各时刻对应的读数；
![P-2026-01-1.1-023解析示意图2](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-023.2-analysis.png)
...
![P-2026-01-1.1-024题目的示意图](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-024-question.png)
**答案**：1.7m/s 或 2.9m/s
**解析**：在 $$\Delta t$$ 内，光束转过角度 $$\Delta\varphi = \frac{\Delta t}{T} \times 360° = 15°$$，由题意知，**有两种可能**，如图所示。
![P-2026-01-1.1-024题目解析的示意图](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-024-analysis.png)
...
![一个高速的子弹击穿了苹果的黑白照片。](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-028-question.png)
**选项**：
A. $$10^{-3}$$s
B. $$10^{-6}$$s
C. $$10^{-9}$$s
...
![一女同学穿着轮滑鞋以一定的速度俯身"滑入"静止汽车的车底](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-029-question.png)
**选项**：
A. 她在车底运动时的加速度
B. 她在车底运动时的平均速度
C. 她刚"滑入"车底时的速度
...
![](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-034-question.png)
**选项**：
A. 3m/s
B. 2m/s
C. 1m/s
...
![](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-035-question.png)
**答案**：9:7；2.1
...
![](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-038-question.png)
...
![](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-043-question.png)
**选项**：
A. 关卡2
B. 关卡3
C. 关卡4
...
![](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-044-question.png)
**选项**：
...
![相关数据表格](https://physics-image-1391307169.cos.ap-nanjing.myqcloud.com/P-2026-01-1.1-049-question.png)
