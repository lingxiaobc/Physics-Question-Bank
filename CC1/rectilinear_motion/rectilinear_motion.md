...
![运动员原地起跳扣篮的示意图](image/P-2026-01-2.3-001-question.png)
**选项**：
A. $$1 < \frac{t_1}{t_2} < 2$$
B. $$2 < \frac{t_1}{t_2} < 3$$
C. $$3 < \frac{t_1}{t_2} < 4$$
...
![固定光滑斜面上木板运动示意图](image/P-2026-01-2.1-001-question.png)
**选项**：
A. $$(\sqrt{3}-1):(\sqrt{2}-1)$$
...
![图(a)阻力-时间关系图和图(b)待画v-t图](image/P-2026-01-2.1-002-question.png)
...
**解析**：(1)$$v-t$$图像如图所示。
![v-t图像解析图](image/P-2026-01-2.1-002-analysis.png)
